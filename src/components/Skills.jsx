        ...
        {entries.map(([cat, items], i) => (
          ...
          >
            ...
            <div className="flex items-center gap-2.5 mb-4">
              <div className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-lg bg-sky-400/10 border border-sky-400/20">
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  {CATEGORY_ICONS[cat] || CATEGORY_ICONS.Tools}
                </svg>
              </div>
              <h4 className="text-sm font-semibold text-sky-400 font-mono-tech">
                {cat.replaceAll("_", " / ")}
              </h4>
            </div>
